...
void transfers_thread(uintptr_t arg) {
    ...
    accounts.push_back(Account(0, 500));
    ...
    accounts.push_back(Account(1, 10000));
    std::queue<Request> requests1;
    requests1.push(Request(3,10));
    requests1.push(Request(0,1000));
    allRequests.push_back(requests1);

    accounts.push_back(Account(2, 10));
    std::queue<Request> requests2;
    requests2.push(Request(1,1000));
    requests2.push(Request(0,1));
    allRequests.push_back(requests2);

    accounts.push_back(Account(3, 300));
    std::queue<Request> requests3;
    requests3.push(Request(1,1000));
    requests3.push(Request(3,1));
