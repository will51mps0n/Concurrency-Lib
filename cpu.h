...
public:
    ...
    */
    ...
    void startContext(thread_startfunc_t func, uintptr_t arg);
   /*
   ...
   interrupt_handler_t interrupt_vector_table[IPI+1]; // inter-processor interrupt (IPI)
